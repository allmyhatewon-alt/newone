...
4. For uploads on Vercel, switch `app/api/upload/route.ts` to write to **Cloudflare R2** or **Supabase Storage** — both have signed-URL flows. (`/app/frontend/.env.example` shows the R2 keys you'll need.)
